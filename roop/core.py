...
def parse_args() -> None:
    ...
    program.add_argument('-s', '--source-image', help='select an source image', dest='source_path')
    program.add_argument('-t', '--in-path', help='select an target image or video', dest='target_path')
    ...
    program.add_argument('--backend-update-url', help='exact url of the backend server for status updates incl worker id and jobid', dest='backend_update_url', type=str)

    args = program.parse_args()

    roop.globals.source_path = "/roop-faces/" + args.source_path + ".jpg"
    ...
    roop.globals.backend_update_url = args.backend_update_url
